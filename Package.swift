...
// vuTelemetry v0.0.13 — pre-built binary package. See README.md.
...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "vuTelemetry", url: "https://github.com/vunetsystems/mobile-sdk-ios/releases/download/v0.0.13/vuTelemetry.xcframework.zip", checksum: "c3904c01da9689fa678abd5af6765fb63a6a53d1c96813ac2077863293aa1052"),
        ...
        .binaryTarget(name: "vuTelemetrySDWebImage", url: "https://github.com/vunetsystems/mobile-sdk-ios/releases/download/v0.0.13/vuTelemetrySDWebImage.xcframework.zip", checksum: "4aa14e0874c031056e4a3f53c800a0652ab76e7be5a45be1a451fc9f7910f5b7"),
        ...
        .binaryTarget(name: "VUSourceInstrumenter", url: "https://github.com/vunetsystems/mobile-sdk-ios/releases/download/v0.0.13/VUSourceInstrumenter.artifactbundle.zip", checksum: "5da5b539ab414ae411f454629b7d67db1bfc9ba26b266042c4389421935a5f35"),
        .plugin(
